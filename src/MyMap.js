...
import AppRoutes from './Routes.js'; // Import the new Routes component
...
const getTalukStyle = (feature) => {
  ...
  return (
    ...
    <MapContainer center={position} zoom={zoomLevel} scrollWheelZoom={true} style={{height:'90vh',width:'100vh',marginLeft:'50%',top:'10px'}}>
      {/* <HeatMap1/> */}
       <HeatMap />
    <MapViewUpdater />
      <TileLayer
